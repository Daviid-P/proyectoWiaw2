...
1	Polen	Poca verdura, poca fruta, muchas grasas	Rotura del ligamento cruzado. Extirpacion de amigdalas. Diabetes de tipo 2.	H	Fumador, bebedor ocasional	2	Insulina y Lantus.	Parado	84
2	No	Dieta normal, muchos vegetales, poca fruta	No.	H	Fumador	0	No.	Contable	90
3	Penicilina	Vegana	Rotura de rodilla izquierda	M	No	1	Aspirina.	Encargada de comedor	71
\.
...
6	Rodilla gravemente fisurada, posible roura en caso de que no se inmovilize la pierna. Se aplica una escayola al paciente.	3	4
\.
...
3	Es una tecnica diagnostica radiologica de forma digital (radiologia digital directa o indirecta) en una base de datos. La imagen se obtiene al exponer al receptor de imagen radiografica a una fuente de radiacion de alta energi­a, comunmente rayos X o radiacion gamma	t	Radiografia
